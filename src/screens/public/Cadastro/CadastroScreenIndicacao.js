...
import providerCadastro from '../../../providers/public/autenticacao/providerCadastroIndicacao';
import Erros from '../../../ui/components/erros';

export default class CadastroSreenIndicacao extends Component {
    ...
    async componentDidMount() {
        document.title = "Cadastro com indicações - Tela de cadastro";
        await this.setState({
            idUsuarioIndicado: this.props.params.idUsuario
        });
    }
    ...
    handleSubmit = async (e) => {
        ...
        const data = {
            ...
            idUsuarioIndicado: this.state.idUsuarioIndicado
        };
